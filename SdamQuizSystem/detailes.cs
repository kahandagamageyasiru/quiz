...
namespace SdamQuizSystem
{
    class detailes
    {
        ...
        List<Question> question1 = new List<Question>()
            {
                ...
                new Question("What is the largest planet in our solar system?", new string[]{"Earth", "Jupiter", "Mars", "Saturn"}, 1),
                new Question("Who was the first president of the United States?", new string[]{"George Washington", "John Adams", "Thomas Jefferson", "James Madison"}, 0)
        ...
        List<Question> question3 = new List<Question>()
            {
                ...
                new Question("What is the average of first 150 natural numbers?", new string[]{ "70", " 70.5", "75", "75.5"}, 2),
                new Question("What is the rate of discount if a car which price was $4,000 was sold for $3,200 ?s", new string[]{"14%", "16%", "18%", "20%"}, 3),
                new Question("What is the value of x in the equation 3x – 15 – 6 = 0 ?", new string[]{"7", "8", "9", "-9"}, 0)
        ...
        public void QandA()
        {
            ...
            Console.WriteLine($"Your final score is: {score}/{question1.Count}");
            if (score == 0)
            {
        ...
        public void AddQuestion()
        {
            ...
            question1.Add(new Question(qustion, new string[] { answer1, answer2, answer3, answer4 }, AnswerIndex1));
        ...
        public void AddQuestion1()
        {
            ...
            question3.Add(new Question(qustion, new string[] { answer1, answer2, answer3, answer4 }, AnswerIndex1));
